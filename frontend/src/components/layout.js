...
function Layout({ children }) {
  return (
    <div className="flex flex-col font-sans min-h-screen text-gray-300">
      ...
      <main className="flex flex-col flex-1  max-w-4xl mx-auto px-4 py-8 md:p-8 w-full bg-gray-800">
        {children}
      </main>

      <footer className="bg-mbmDark neu-border w-11/12 mx-auto my-2 rounded-lg">
